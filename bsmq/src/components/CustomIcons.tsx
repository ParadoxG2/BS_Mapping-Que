  ...
  return(
    <SvgIcon>
       <svg 
        ...
        fill='#ffffff'>
          <text kerning="auto" font-family="Myriad Pro" fill="rgb(0, 0, 0)" transform="matrix( -0.22692535283141, -0.84194217989076, 2.04517796859272, -0.54928314837009,1723.98240689018, 302.283163270922)" font-size="10px"><tspan font-size="2px" font-family="Bowlby One" fill="#FFFFFF">&#60;</tspan></text>
          <text kerning="auto" font-family="Myriad Pro" fill="rgb(0, 0, 0)" font-size="302px" x="730.5px" y="611.172px"><tspan font-size="302px" font-family="Bowlby One" fill="#FFFFFF">BSMQ</tspan></text>
          <path fill-rule="evenodd"  stroke="rgb(0, 0, 0)" stroke-width="1px" stroke-linecap="butt" stroke-linejoin="miter" fill="rgb(255, 255, 255)"
          d="M153.857,67.149 L228.961,52.128 L336.762,594.127 L261.658,609.148 C168.455,627.789 77.859,567.286 59.307,474.011 L18.689,269.790 C0.137,176.515 60.654,85.789 153.857,67.149 Z"/>
          <path fill-rule="evenodd"  stroke="rgb(0, 0, 0)" stroke-width="1px" stroke-linecap="butt" stroke-linejoin="miter" fill="rgb(255, 255, 255)"
          d="M488.321,568.019 L411.814,568.087 L411.400,15.164 L487.907,15.095 C582.850,15.010 659.874,92.080 659.945,187.235 L660.101,395.571 C660.173,490.726 583.264,567.934 488.321,568.019 Z"/>
        </svg>
    </SvgIcon>
  );
}